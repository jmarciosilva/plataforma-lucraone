...
class StoreWebCustomerRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()
            ? Gate::forUser($this->user())->allows('create', Customer::class)
            : false;
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'company_id.required' => 'selecione a empresa do cliente.',
        ];
    }
}
